...
-- Fri 23 Nov 2018 06:33:14 PM CET
...
CREATE TABLE IF NOT EXISTS `gestorACOES`.`socio` (
  ...
  `eatado` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gestorACOES`.`joven` (
  ...
  `nombre` VARCHAR(45) NOT NULL,
  `apellidos` VARCHAR(45) NOT NULL,
  `nombre_del_padre` VARCHAR(45) NULL,
  `nombre_de_la_madre` VARCHAR(45) NULL,
  `estado` VARCHAR(45) NULL,
  `url_foto` VARCHAR(200) NULL,
  `fecha_nacimiento` DATE NULL,
  `fecha_de_alta_acoes` DATE NOT NULL,
  `fecha_de_alta` DATE NULL,
  `fecha_de_salida_acoes` DATE NULL,
...
CREATE TABLE IF NOT EXISTS `gestorACOES`.`envios` (
  ...
  `eviado_por_socio` TINYINT(1) NULL,
  `recibido` TINYINT(1) NULL,
  `respuestaA` INT(11) NULL,
...
-- -----------------------------------------------------
-- Table `gestorACOES`.`permisos_de_usuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestorACOES`.`permisos_de_usuario` ;

CREATE TABLE IF NOT EXISTS `gestorACOES`.`permisos_de_usuario` (
  `usuario` INT(11) NOT NULL,
  `permiso` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`usuario`, `permiso`),
  INDEX `fk_usuario_has_permiso_permiso1_idx` (`permiso` ASC),
  INDEX `fk_usuario_has_permiso_usuario1_idx` (`usuario` ASC),
...
CREATE TABLE IF NOT EXISTS `gestorACOES`.`proyecto` (
  ...
  `nombre` VARCHAR(45) NOT NULL,
  `requisitos_participacion` LONGTEXT NULL,
  `descripcion` LONGTEXT NULL,
...
CREATE TABLE IF NOT EXISTS `gestorACOES`.`transaccion` (
  ...
  `proyecto` INT(11) NULL,
  `apadrinamiento` INT(11) NULL,
